    ...
    <div class="container">
        ...
        <!--  дропдавн-->
            ...
            <ul class="navbar-nav header__items list-unstyled">
                ...
                <div class="dropdown-menu d-none d-lg-inline" style="padding-top:0; padding-bottom:0;">
                ...
                <li class="nav-item list-unstyled ml-2 ml-1 header__item " v-for='element in header_menu'> 
                    <img src="communication/dot.jpg" alt="dot" class="d-none d-lg-inline">
                    <a :href="element.url">{{element.name}}</a> 
                </li>
            </ul>
        </div>
        <div class="inner-addon left-addon button">
            <span class="glyphicon glyphicon-search" style="margin-top:-5px;" aria-hidden="true" ></span>
